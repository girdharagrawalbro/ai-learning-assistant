...
exports.cleanupOldChatLogs = exports.onQuizAttemptCreated = exports.updateLearningStreaks = exports.summarizeContent = exports.extractConcepts = exports.getStudyRecommendations = exports.generateQuiz = exports.chatWithStudyBuddy = void 0;
...
const getGeminiClient = () => {
    var _a;
    const apiKey = ((_a = functions.config().gemini) === null || _a === void 0 ? void 0 : _a.apikey) || process.env.GEMINI_API_KEY;
    if (!apiKey) {
 ...
 */
exports.chatWithStudyBuddy = functions.https.onRequest((req, res) => {
 ...
 */
exports.getStudyRecommendations = functions.https.onRequest((req, res) => {
    corsHandler(req, res, async () => {
        try {
 ...
 */
exports.extractConcepts = functions.https.onRequest((req, res) => {
    corsHandler(req, res, async () => {
        try {
 ...
 */
exports.updateLearningStreaks = functions.pubsub
    ...
    try {
        ...
        progressSnapshot.docs.forEach((doc) => {
            ...
            const lastStudy = (_a = progress.lastStudyDate) === null || _a === void 0 ? void 0 : _a.toDate();
            if (lastStudy) {
                const daysDiff = Math.floor((yesterday.getTime() - lastStudy.getTime()) / (1000 * 60 * 60 * 24));
 ...
 */
exports.onQuizAttemptCreated = functions.firestore
    ...
    try {
        ...
        if (progressDoc.exists) {
            ...
            const newAverage = (((progress.averageScore || 0) * (progress.totalQuizzesTaken || 0) + scorePercent) /
                newTotalQuizzes);
 ...
 */
exports.cleanupOldChatLogs = functions.pubsub
